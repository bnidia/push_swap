...
if [ $res -gt 1500 ]
then
echo "1Test result on $from..$to randoms: ${blue}$res${normal}   0️⃣  ❕  5️⃣  ❗️"
let "sred += $res"
elif [ $res -gt 1300 ]
then
echo "2Test result on $from..$to randoms: ${blue}$res${normal}   1️⃣  ❕  5️⃣     ✅"
let "sred += $res"
elif [ $res -gt 1100 ]
then
echo "3Test result on $from..$to randoms: ${blue}$res${normal}   2️⃣  ❕  5️⃣     ✅  ✅"
let "sred += $res"
elif [ $res -gt 900 ]
then
echo "4Test result on $from..$to randoms: ${blue}$res${normal}   3️⃣  ❕  5️⃣     ✅  ✅  ✅"
let "sred += $res"
elif [ $res -gt 700 ]
then
echo "5Test result on $from..$to randoms: ${blue}$res${normal}   4️⃣  ❕  5️⃣     ✅  ✅  ✅  ✅"
let "sred += $res"
#echo $ARG
elif [ $res -gt 0 ]
then
echo "6Test result on $from..$to randoms: ${blue}$res${normal}   5️⃣  ❕  5️⃣     ✅  ✅  ✅  ✅  ✅"
let "sred += $res"
fi
elif [ $dif -eq 500 ]
then
if [ $res -gt 11500 ]
then
echo "7Test result on $from..$to randoms: ${blue}$res${normal}   0️⃣  ❕  5️⃣  ❗️"
let "sred += $res"
elif [ $res -gt 10000 ]
then
echo "8Test result on $from..$to randoms: ${blue}$res${normal}   1️⃣  ❕  5️⃣     ✅"
let "sred += $res"
elif [ $res -gt 8500 ]
then
echo "9Test result on $from..$to randoms: ${blue}$res${normal}   2️⃣  ❕  5️⃣     ✅  ✅"
let "sred += $res"
elif [ $res -gt 7000 ]
then
echo "10Test result on $from..$to randoms: ${blue}$res${normal}   3️⃣  ❕  5️⃣     ✅  ✅  ✅"
let "sred += $res"
elif [ $res -gt 5500 ]
then
echo "11Test result on $from..$to randoms: ${blue}$res${normal}   4️⃣  ❕  5️⃣     ✅  ✅  ✅  ✅"
let "sred += $res"
elif [ $res -gt 0 ]
then
echo "12Test result on $from..$to randoms: ${blue}$res${normal}   5️⃣  ❕  5️⃣     ✅  ✅  ✅  ✅  ✅"
let "sred += $res"
fi
elif [ $dif -eq 5 ]
then
if [ $res -gt 12 ]
then
echo "13Test result on $from..$to randoms: ${blue}$res${normal}    ❌"
else
echo "14Test result on $from..$to randoms: ${blue}$res${normal}    ✅"
fi
else
echo "15Test result on $from..$to randoms: ${blue}$res${normal}"
fi
done
...
if [ $dif -eq 100 ]
    ...
    if [ $koef -gt 1300 ]
    then
    echo "Middle value: ${blue}$koef${normal}   Grade is :  0️⃣     ❗️"
    elif [ $koef -gt 1300 ]
    then
    echo "Middle value: ${blue}$koef${normal}   Grade is :  1️⃣     ✅"
    elif [ $koef -gt 1100 ]
    then
    echo "Middle value: ${blue}$koef${normal}   Grade is :  2️⃣     ✅  ✅"
    elif [ $koef -gt 900 ]
    then
    echo "Middle value: ${blue}$koef${normal}   Grade is :  3️⃣     ✅  ✅  ✅"
    elif [ $koef -gt 700 ]
    then
    echo "Middle value: ${blue}$koef${normal}   Grade is :  4️⃣      ✅  ✅  ✅  ✅"
    elif [ $koef -gt 0 ]
    then
    echo "Middle value: ${blue}$koef${normal}   Grade is :  5️⃣      ✅  ✅  ✅  ✅  ✅"
    fi
elif [ $dif -eq 500 ]
    then
        if [ $koef -gt 11500 ]
